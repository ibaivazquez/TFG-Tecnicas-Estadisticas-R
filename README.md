# TFG – Técnicas Estadísticas de Análisis de Datos con R

El presente Trabajo Fin de Grado expone un estudio introductorio sobre tres técnicas estadísticas utilizadas en el análisis de datos multivariantes, todas ellas implementadas en RStudio.  
Se introducen conceptos básicos relacionados con el análisis de datos de grandes dimensiones en el ámbito empresarial.  
...
## Objetivo
Demostrar la aplicación de técnicas estadísticas para el análisis de datos y la extracción de insights relevantes para la toma de decisiones empresariales.
